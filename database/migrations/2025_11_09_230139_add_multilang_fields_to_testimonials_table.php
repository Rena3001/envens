...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('testimonials', function (Blueprint $table) {
            ...
            // Müştərinin vəzifəsi və ya rolu
            ...
            // Müştərinin rəy mətni
            $table->text('message_az')->nullable()->after('message');
            $table->text('message_en')->nullable()->after('message_az');
            $table->text('message_ru')->nullable()->after('message_en');
        });
    }
